...
var FollowWorker = function () {
  function FollowWorker() {
    _classCallCheck(this, FollowWorker);
  }

  _createClass(FollowWorker, [{
    key: 'start',
    value: function start() {
      ...
      _models.User.findAll({
        ...
        if (list.length > 0) {
          ...
          console.log(new Date().toLocaleString() + ' follow worker wait for 1200s to start again');
          setTimeout(function () {
            _this.start();
          }, 1200000);
        }
